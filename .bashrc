...
export EDITOR=vim
stty stop undef
alias sgrep='grep -nr --exclude-dir=.svn -P'

# less wrapper under httpie (https://github.com/jkbr/httpie)
function httpless {
    http --pretty=all --print=hb "$@" | less -R;
}

# add git branch to console promt http://martinvalasek.com/blog/current-git-branch-name-in-command-prompt
